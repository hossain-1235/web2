                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input name="mobile" type="text" class="form-control" placeholder="Mobile Number" value="{{ old('mobile') }}" />
                                </div>
                            </div>
                ...
                <div class="col-12 col-lg-4 col-md-12">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <div class="cart_single_caption pl-2">
                                            ...
                                            <h4 class="fs-md ft-medium mb-3 lh-1">
                                                &#2547;{{ App\Models\Inventory::where('product_id', $cart->product_id)->where('color_id', $cart->color_id)->where('size_id', $cart->size_id)->first()->discount_price }} x {{ $cart->quantity }}
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mb-4">
                        <div class="form-group">
                            ...
                            <ul class="no-ul-list">
                                ...
                                <li>
                                    <input id="c2" class="radio-custom charge" name="charge" type="radio" value="150">
                    ...
                    <div class="card mb-4 gray">
                        ...
                        <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                            ...
                            <span>Subtotal</span> <span class="ml-auto text-dark ft-medium">&#2547;<span id="sub_total">{{ $sub_total }}</span></span>
                            </li>
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                            ...
                            @if ($coupon_discount)
                                <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                <span>Coupon Discount</span> <span class="ml-auto text-dark ft-medium" >&#2547;<span >{{ $discount_amount }}</span></span>
                                </li>
                            @endif
                            @php
                                $total_amount = $sub_total - $discount_amount;
                            @endphp
                            <input type="hidden" id="discount_amount" value="{{ $discount_amount }}" name="discount">
...
<script>
    $('.charge').click(function(){
        ...
        $('#total').html(parseInt(sub_total)+parseInt(charge) - parseInt(discount_amount))
    })
</script>
